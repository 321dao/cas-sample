...
import (
	...
	"github.com/gosample/cas-sample/server/authenticator"
	"github.com/gosample/cas-sample/server/config"
	"github.com/gosample/cas-sample/server/interceptor"
	"github.com/gosample/cas-sample/server/protocol/cas"
	"github.com/gosample/cas-sample/server/protocol/oauth"
	"github.com/gosample/cas-sample/server/util"
)
...
var (
	c = flag.String("config", "/Users/billgo/gowork/src/github.com/gosample/cas-sample/server/config.yaml", "path to GoCAS configuration file")
)
